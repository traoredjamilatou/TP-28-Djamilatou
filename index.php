 ...
 <div class="box">
    ...
    <div class="content">
      <div>
        ...
        <p>Bobo-Dioulasso est la capitale économique du Burkina Faso et la deuxième ville en population après Ouagadougou. C'est la capitale de la région des ...</p>
        <p>Elle fut fondée par des agriculteurs Bobo venus du Mandé, l'actuel Mali vers 1050. Par la suite, le village prendra le nom de Sya avec l'arrivée progressive des commerçants (Dioula), venus du royaume de Kong. D'après une légende, Sya était une jeune vendeuse de dolo (la bière de mil), connue pour sa générosité.20 oct. 2017</p>
 ...
 <!---box -->
  <div class="box">
    ...
    <div class="content">
      <div>
        <h1>BANFORA</h1>
        <p>Banfora est une ville du sud-ouest du Burkina Faso fondée en 1903. Elle est la capitale de la région des Cascades et de la Province de la Comoé Pays du ...</p>
        <p>Histoire. Selon la tradition, le nom de Banfora viendrait de Gouafo, le fondateur.</p>
 ...
 <!---box -->
  <div class="box">
    ...
    <div class="content">
      <div>
        <h1>SABOU</h1>
        <p>Sabou est un département du Burkina Faso située dans la province du Boulkiemdé et dans la région Centre-Ouest. En 2006, le dernier recensement comptabilise ...</p>
        <p>Les crocodiles sacrés de Sabou. Ils sont plus d'une centaine et vivent dans une mare depuis des siècles au côté nord de Sabou. Pour avoir sauvé la vie de leur ...</p>
        <a href="SABOU.php">SABOU<i class="bi bi-power"></i></a>
      </div>
    </div>
  </div>
   <!---box -->
